...
app.post('/questions', function (req, res) {
  ...
  var newTodo = new Question({
    question: req.body.question,
    answer: req.body.answer,
    author: req.body.author = 'xqf',
  });
...
app.delete('/questions/:todoId', function (req, res) {
  ...
  Question.findByIdAndRemove(lectionId, function (err, removed) {
    if (err) {
