...
var Price = require('./prices');

app.get('/prices', function (req, res) {
  Price.find({}, function (err, todos) {
    if (err) {
...
app.delete('/prices/:todoId', function (req, res) {
  ...
  Price.findByIdAndRemove(lectionId, function (err, removed) {
    if (err) {
